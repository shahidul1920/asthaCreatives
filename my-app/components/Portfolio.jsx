...
const portfolioItems = [
    { id: 1, name: "Our Design Work", src: designImg, alt: "Portfolio design work", link: "/" },
    { id: 2, name: "Brand Identity Creation", src: marketingImg, alt: "Portfolio Brand Identity", link: "/" },
    { id: 3, name: "Web Development", src: webImg, alt: "Portfolio Web Development", link: "/" },
    { id: 4, name: "Data Analysis", src: data, alt: "Portfolio data analysis", link: "/" },
]
...
const Portfolio = () => {
    ...
    const handleEnter = (e) => {
        ...
        panels.forEach((panel) => {
            ...
            gsap.to(panel, { flexGrow: isActive ? 5 : 1, duration: 0.7, ease: 'power3.out' })
    ...
    const handleLeave = () => {
        const panels = Array.from(containerRef.current.querySelectorAll('.portfolio-panel'))
        panels.forEach((panel, index) => {
            const isDefault = index === DEFAULT_ACTIVE_INDEX
            gsap.to(panel, { flexGrow: isDefault ? 5 : 1, duration: 0.7, ease: 'power3.out' })
            gsap.to(panel.querySelector('.portfolio-overlay'), {
                ...
                >
                    {portfolioItems.map((item, index) => (
                        <Link
                            ...
                            style={{ flexGrow: index === DEFAULT_ACTIVE_INDEX ? 5 : 1, flexBasis: 0, flexShrink: 1 }}
                        >
