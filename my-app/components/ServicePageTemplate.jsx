                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        {service.tiers.map((tier) => (
                            <div
                                key={tier.name}
                                className={`tier-card flex h-full flex-col rounded-2xl border p-8 ${tier.highlighted
                        ...
                        <table className="w-full min-w-[640px] border-collapse text-left">
                            <thead>
                                <tr className="border-b border-gray-200 bg-gray-50">
                                    ...
                                    {service.tiers.map((tier) => (
                                        <th key={tier.name} className="p-4 text-center text-sm font-semibold text-gray-900">
                                            {tier.name}
                                        </th>
                                    ))}
                                </tr>
                                ...
                                {service.comparison.rows.map((row) => (
                                    <tr key={row.feature} className="border-b border-gray-100 last:border-0">
                                        ...
                                        {row.values.map((value, i) => (
                                            <td key={i} className="p-4 text-center text-sm text-gray-600">
                                                {renderCell(value)}
                                            </td>
                                        ))}
                                    </tr>
