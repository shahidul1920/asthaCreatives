        ...
        <footer className="w-full bg-brand text-white">
            <div className="container mx-auto px-4 py-16 md:py-20">
                <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr]">
                    ...
                    <div>
                        ...
                        <p className="mt-5 max-w-xs text-sm leading-relaxed text-white/70">
                            Your dedicated branding partner with high impact design, strategic marketing, and actionable insights.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="mt-5 flex flex-col gap-3 text-sm text-white/70">
                            ...
                            <li>
                                <a href="mailto:contact@redmun.com" className="transition-colors duration-200 hover:text-white">
                                    contact@redmun.com
                                </a>
                            </li>
                            <li>
                                <a href="tel:+8801711994608" className="transition-colors duration-200 hover:text-white">
                                    +880 1711 994608
                                </a>
                            </li>
                            <li>
                                <a href="tel:+8801308379019" className="transition-colors duration-200 hover:text-white">
                                    +880 1308 379019
                                </a>
                            </li>
                        </ul>
                ...
                <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 text-xs text-white/50 sm:flex-row">
                    <p>&copy; {new Date().getFullYear()} Astha Creatives. All rights reserved.</p>
